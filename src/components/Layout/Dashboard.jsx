        ...
        <div className="w-[91%] space-y-6">
          ...
          >
            ...
            <div className="flex items-center mt-4 space-x-3">
              ...
              <div className="flex flex-col items-center gap-3">
                <Button variant="contained" style={{ backgroundColor: "#FFA500" }} onClick={handleTeaStart}>
                  Tea Break Start
                </Button>
                <div>{teaStartTime ? formatTime(new Date(teaStartTime)) : "00:00"}</div>
              </div>
              <div className="flex flex-col items-center gap-3">
                <Button variant="contained" style={{ backgroundColor: "#FFA500" }} onClick={handleTeaEnd}>
                  Tea Break End
                </Button>
                <div>{teaEndTime ? formatTime(new Date(teaEndTime)) : "00:00"}</div>
              </div>
              <div className="flex flex-col items-center gap-3">
                <Button variant="contained" style={{ backgroundColor: "#1E40AF" }} onClick={handleLunchStart}>
                  Lunch Break Start
                </Button>
                <div>{lunchStartTime ? formatTime(new Date(lunchStartTime)) : "00:00"}</div>
              </div>
              <div className="flex flex-col items-center gap-3">
                <Button variant="contained" style={{ backgroundColor: "#1E40AF" }} onClick={handleLunchEnd}>
                  Lunch Break End
                </Button>
                <div>{lunchEndTime ? formatTime(new Date(lunchEndTime)) : "00:00"}</div>
              </div>
            </div>
          </div>
